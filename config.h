...
static const Key keys[] = {
  ...
  { MODKEY|Mod1Mask,              XK_period, spawn,          SHCMD("amixer set 'Master' 10%+") },
  { MODKEY|Mod1Mask,              XK_comma,  spawn,          SHCMD("amixer set 'Master' 10%-") },
  { Mod1Mask|ShiftMask,           XK_s,      spawn,          SHCMD("screenshot")},
